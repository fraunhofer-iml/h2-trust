...
export class CreateProductionEntity {
    ...
    static of(dto: CreateProductionDto, recordedBy: string, hydrogenColor: string, hydrogenStorageUnitId: string, companyIdOfPowerProductionUnit: string, companyIdOfHydrogenProductionUnit: string): CreateProductionEntity {
