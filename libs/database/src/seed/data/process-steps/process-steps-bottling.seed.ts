...
export const ProcessStepsBottlingSeed = <ProcessStep[]>[
  ...
  },
  {
    ...
    processTypeName: getElementOrThrowError(ProcessTypesSeed, 2, 'Process Type').name,
    batchId: getElementOrThrowError(HydrogenBatchesBottledSeed, 3, 'Hydrogen Batch Bottled').id,
    userId: getElementOrThrowError(UsersSeed, 1, 'User').id,
    unitId: getElementOrThrowError(HydrogenStorageUnitsSeed, 0, 'Hydrogen Storage Unit').id,
  },
  {
    ...
    processTypeName: getElementOrThrowError(ProcessTypesSeed, 2, 'Process Type').name,
    batchId: getElementOrThrowError(HydrogenBatchesBottledSeed, 4, 'Hydrogen Batch Bottled').id,
    userId: getElementOrThrowError(UsersSeed, 1, 'User').id,
    unitId: getElementOrThrowError(HydrogenStorageUnitsSeed, 0, 'Hydrogen Storage Unit').id,
  },
  {
    ...
    processTypeName: getElementOrThrowError(ProcessTypesSeed, 2, 'Process Type').name,
    batchId: getElementOrThrowError(HydrogenBatchesBottledSeed, 5, 'Hydrogen Batch Bottled').id,
    userId: getElementOrThrowError(UsersSeed, 1, 'User').id,
    unitId: getElementOrThrowError(HydrogenStorageUnitsSeed, 0, 'Hydrogen Storage Unit').id,
  },
  {
    ...
    processTypeName: getElementOrThrowError(ProcessTypesSeed, 2, 'Process Type').name,
    batchId: getElementOrThrowError(HydrogenBatchesBottledSeed, 6, 'Hydrogen Batch Bottled').id,
    userId: getElementOrThrowError(UsersSeed, 1, 'User').id,
    unitId: getElementOrThrowError(HydrogenStorageUnitsSeed, 0, 'Hydrogen Storage Unit').id,
  },
  {
    ...
    processTypeName: getElementOrThrowError(ProcessTypesSeed, 2, 'Process Type').name,
    batchId: getElementOrThrowError(HydrogenBatchesBottledSeed, 7, 'Hydrogen Batch Bottled').id,
    userId: getElementOrThrowError(UsersSeed, 1, 'User').id,
    unitId: getElementOrThrowError(HydrogenStorageUnitsSeed, 0, 'Hydrogen Storage Unit').id,
  },
  {
    ...
    processTypeName: getElementOrThrowError(ProcessTypesSeed, 2, 'Process Type').name,
    batchId: getElementOrThrowError(HydrogenBatchesBottledSeed, 8, 'Hydrogen Batch Bottled').id,
    userId: getElementOrThrowError(UsersSeed, 1, 'User').id,
    unitId: getElementOrThrowError(HydrogenStorageUnitsSeed, 0, 'Hydrogen Storage Unit').id,
  },
];
