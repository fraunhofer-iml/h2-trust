...
export const PowerPurchaseAgreementDecisionSeed: readonly PowerPurchaseAgreementDecision[] = Object.freeze([
  {
    ...
    grantedPowerProductionUnitId: UnitSeed[0].id,
  },
  {
    ...
    userId: UserSeed[0].id,
    grantedPowerProductionUnitId: UnitSeed[1].id,
  },
  {
    ...
    userId: UserSeed[0].id,
    grantedPowerProductionUnitId: UnitSeed[2].id,
  },
  {
    ...
    userId: UserSeed[0].id,
    grantedPowerProductionUnitId: UnitSeed[3].id,
  },
]);
