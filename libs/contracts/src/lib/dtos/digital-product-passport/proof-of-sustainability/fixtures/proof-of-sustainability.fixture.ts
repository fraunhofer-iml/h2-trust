...
import { ProofOfSustainabilityDto } from '@h2-trust/contracts/dtos';
...
export const ProofOfSustainabilityDtoFixture = {
  create: (overrides: Partial<ProofOfSustainabilityDto> = {}): ProofOfSustainabilityDto => ({
    batchId: overrides.batchId ?? 'hydrogen-batch-1',
    totalEmissions: overrides.totalEmissions ?? 100,
