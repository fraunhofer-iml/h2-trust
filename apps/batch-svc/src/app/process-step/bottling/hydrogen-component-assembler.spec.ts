...
import { ProcessStepEntity, QualityDetailsEntity } from '@h2-trust/amqp';
...
describe('HydrogenComponentAssembler', () => {
  ...
  beforeEach(() => {
    bottlingProcessStep = {
      ...
      batch: {
        amount: 1,
        qualityDetails: new QualityDetailsEntity('qd-0', HydrogenColor.MIX),
  ...
  it('should calculate hydrogen composition with one color', () => {
    bottlingProcessStep.batch.predecessors = [
      { amount: 1, qualityDetails: new QualityDetailsEntity('qd-0', HydrogenColor.GREEN), type: BatchType.HYDROGEN },
    ];
  ...
  it('should not calculate hydrogen composition with an invalid predecessor type', () => {
    bottlingProcessStep.batch.predecessors = [
      { amount: 1, qualityDetails: new QualityDetailsEntity('qd-0', HydrogenColor.GREEN), type: BatchType.HYDROGEN },
      { amount: 2, qualityDetails: new QualityDetailsEntity('qd-1', HydrogenColor.GREEN), type: BatchType.POWER },
    ];
