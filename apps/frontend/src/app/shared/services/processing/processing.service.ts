...
import { BottlingDto, ProcessingOverviewDto, ProcessType, ProductPassDto } from '@h2-trust/api';
...
export class ProcessingService {
  ...
  findBatchById(id: string) {
    return lastValueFrom(
      this.httpClient.get<ProductPassDto>(`${BASE_URL}${ApiEndpoints.processes.getProcesses}/${id}`),
    );
  }
}
