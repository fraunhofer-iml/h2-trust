...
const BATCH_TYPE_ICON_BY_TYPE: Record<BatchType, string> = {
  ...
  [BatchType.H2_PRODUCTION]: ICONS.PROCESS_STEPS.HYDROGEN_PRODUCTION,
...
const CALCULATION_TOPIC_ICON_BY_TYPE: Record<CalculationTopic, string> = {
  ...
  [CalculationTopic.HYDROGEN_PRODUCTION]: ICONS.PROCESS_STEPS.HYDROGEN_PRODUCTION,
  ...
  [CalculationTopic.HYDROGEN_COMPRESSION]: ICONS.PROCESS_STEPS.HYDROGEN_BOTTLING,
  [CalculationTopic.HYDROGEN_END_USE]: ICONS.PROCESS_STEPS.HYDROGEN_BOTTLING,
};
...
const PROCESS_STEP_ICON_BY_TYPE: Record<ProcessType, string> = {
  ...
  [ProcessType.HYDROGEN_COMPRESSION]: ICONS.UNITS.COMPRESSION,
  [ProcessType.HYDROGEN_STORAGE]: ICONS.UNITS.HYDROGEN_STORAGE,
  [ProcessType.HYDROGEN_END_USE]: ICONS.UNITS.END_USE,
};
