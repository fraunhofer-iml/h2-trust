...
export const H2TrustRouterLinks = {
  ...
  BATCH: ['/', H2TrustRoutes.BATCHES] as const,
  BATCH_DETAILS: (id: string) => ['/', H2TrustRoutes.BATCHES, id] as const,
  BATCH_EDIT: (id: string) => ['/', H2TrustRoutes.BATCHES, id, 'edit'] as const,
  BATCH_CREATE: ['/', H2TrustRoutes.BATCHES, 'create'] as const,
