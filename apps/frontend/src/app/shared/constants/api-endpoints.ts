...
import { BFF_URL } from '../../../environments/environment';

const USERS_ENDPOINT = BFF_URL + '/users/';
const UNITS_ENDPOINT = BFF_URL + '/units/';
const COMPANIES_ENDPOINT = BFF_URL + '/companies/';
const POWER_PURCHASE_AGREEMENTS_ENDPOINT = BFF_URL + '/power-purchase-agreements/';
const BOTTLING_ENDPOINT = BFF_URL + '/bottlings/';
const PRODUCTION_ENDPOINT = BFF_URL + '/productions/';
const FILE_DOWNLOAD_ENDPOINT = BFF_URL + '/file-download/';
