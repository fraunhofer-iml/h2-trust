...
export const DisplayLabels = {
  ...
  TRANSPORTATION_PIPELINE: 'Transportation with Pipeline',
  TRANSPORTATION_TRAILER: 'Transportation with Trailer',
...
export const LogMessages = {
  ...
  PROCESSING_CHUNK: (start: number, end: number) => `Processing ${start} to ${end}`,
} as const;
