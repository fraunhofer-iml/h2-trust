  ...
  it('should create production process steps and call batchService.send for each period', async () => {
    ...
    actualResponse
      ...
      .forEach((processStepEntity) => {
        ...
        expect(processStepEntity.batch).toHaveProperty('owner', { id: createProductionEntity.companyIdOfPowerProductionUnit });
    ...
    actualResponse
      ...
      .forEach((processStepEntity) => {
        ...
        expect(processStepEntity.batch).toHaveProperty('owner', { id: createProductionEntity.companyIdOfHydrogenProductionUnit });
        expect(processStepEntity.batch).toHaveProperty('hydrogenStorageUnitId', createProductionEntity.hydrogenStorageUnitId);
        expect(processStepEntity).toHaveProperty('recordedBy', { id: createProductionEntity.recordedBy });
